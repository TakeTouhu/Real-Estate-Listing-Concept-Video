import type { BillingCycleRevenueReader, SceneRevenueReader } from "./ports";

/**
 * The revenue readers that exist today: none.
 *
 * Both return `null`, and that is the accurate answer rather than a placeholder
 ...
 * organization pays in a billing cycle or what one scene earned.
 *
 ...
 * cannot authorize anything at all until the billing layer supplies these, which
...
export function createUnavailableSceneRevenueReader(): SceneRevenueReader {
  return {
    async revenueYen() {
      return null;
    },
