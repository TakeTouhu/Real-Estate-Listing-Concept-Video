...
function generation(overrides: Partial<SceneGeneration> = {}): SceneGeneration {
  return {
    ...
    // A V2 row: the ambiguous V1 column is null and the delivery snapshot is
    // complete. `frozenExecutionPromptFrom` reads none of this, which is the
    // point of keeping the fixture honest rather than minimal.
